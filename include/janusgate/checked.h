 ...
 * @thread_safety This function is reentrant.
 */
JG_PUBLIC bool jg_read_u64_be(const uint8_t *data,
                              size_t data_size,
                              size_t offset,
                              uint64_t *value);
...
/**
 * @brief Store an unsigned 32-bit integer in network byte order.
 *
 * @param[out] data Destination buffer.
 * @param[in] data_size Available bytes in @p data.
 * @param[in] offset Offset of the first destination byte.
 ...
 * @thread_safety This function is reentrant.
 */
JG_PUBLIC bool jg_write_u32_be(uint8_t *data,
                               size_t data_size,
                               size_t offset,
                               uint32_t value);

/**
 * @brief Store an unsigned 64-bit integer in network byte order.
 *
 * @param[out] data Destination buffer.
 * @param[in] data_size Available bytes in @p data.
 * @param[in] offset Offset of the first destination byte.
 ...
 * @thread_safety This function is reentrant.
 */
JG_PUBLIC bool jg_write_u64_be(uint8_t *data,
                               size_t data_size,
                               size_t offset,
                               uint64_t value);
